<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_manage.aspx.cs" Inherits="gestion_de_la_bibliothèque.admin_manage" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta charset="utf-8">
				<title>图书管理系统-管理员变动</title>
				<!--这是管理员登录后进入的界面-->
...
<body>
    ...
    <form id="form1" runat="server">
        <br />
        <h1 style="color: darkslategray; font-size: 32px; margin-left:50px;">管理员变动</h1>
        <br />
    ...
    &nbsp;
        ...
        <p style="font-size: 20px;margin-left:50px;">
    &nbsp;
            <asp:Label ID="Label3" runat="server" Text="管理员密码："></asp:Label>
